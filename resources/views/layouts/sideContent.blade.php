...
<div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 conversations">
  ...
  <div class="inbox" id="messagelist" style="display:none">
    ...
    <div class="msg friend">
      ...
      <div class="details"
        onclick="messageBox(1,'{{$message->user->image}}','{{$message->user->name}}',{{$message->user->id}},{{Session::get('CurrentUser')->id}},'{{ csrf_token() }}')">
        <div class="par">
  ...
  <div class="inbox" id="friendslist">
    ...
    <div class="msg friend user_search" id="{{strtolower($user->name)}}" onmouseover="clicks(1,'friend',{{$user->id}})"
      ...
      <div class="perosn">
        <div class="state"></div>
        <div class="profile">
          <a href="profile{{$user->id}}/0">
            <img src="../{{$user->image}}" alt="" />
          </a> </div>
      </div>
      <div class="details"
        onclick="messageBox(1,'{{$user->image}}','{{$user->name}}',{{$user->id}},{{Session::get('CurrentUser')->id}},'{{ csrf_token() }}')">
        <div class="par">
          <h6 id="h6friend{{$user->id}}">{{$user->name}}</h6>
          <p id="pfriend{{$user->id}}">
            {{$user->details->about}}
          </p>
        </div>
  ...
  {{-- <div class="inbox">
    ...
    <div class="msg">
      ...
      <div class="details">
        ...
        <div class="par">
          <h6>omar yassir</h6>
          <p>
            hello there 🙋‍♂ we are going hiking 🌈🌴,
            interested?
          </p>
        </div>
    ...
    <div class="msg active">
      ...
      <div class="perosn other">
        <div class="profile">
          <img src="img/avatar/user2.jpg" alt="" />
        </div>
      </div>
      <div class="perosn other other2">
        <div class="profile">
          <img src="img/avatar/user3.jpg" alt="" />
        </div>
      </div>
      ...
      <div class="details">
        ...
        <div class="par">
          <h6>ui ux Geeks</h6>
          <p>
            yo guys, check out the new flutter ui 🌟pretty
            amazing ha?
          </p>
        </div>
    ...
    <div class="msg">
      ...
      <div class="details">
        ...
        <div class="par">
          <h6>calum scott</h6>
          <p>
            check out this article about the new mobile apps ui
            trends for 2020! 🔥😍
          </p>
        </div>

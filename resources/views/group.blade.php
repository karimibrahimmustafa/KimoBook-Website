    ...
    <div class="wrapper">
        ...
        <div class='message'>
            <div class='messageContainer'>
                ...
                <iframe src="@if($postnum!=0){{'../'}}@endif/message/0" scroll name="message" scrolling="yes" id='message' frameborder="0" base
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9 content-side">
                    ...
                    <div class="content-child">
                            ...
                            <div class="col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 feed">
                                <div class="child">
                                    <div class="stories prof">
                                        ...
                                        <img class="cover" src="@if($postnum!=0){{'../'}}@endif{{Session::get('CurrentGroup')->cover}}" alt="" />
                                        ...
                                        <div class="hold photo">
                                            <div class="profile">
                                                <img src="@if($postnum!=0){{'../'}}@endif{{Session::get('CurrentGroup')->image}}"
                                    ...
                                    <div class="about" onmouseover="showbubble(4)" onmouseout="hidebubble(4)">
                                        <div style="padding-top: 15px;padding-bottom: 15px;">
                                            <div style="text-align: center;">About :
                                                {{Session::get('CurrentGroup')->about}}</div>
                                            <div style="text-align: center;">
                                                <i class="fas fa-user-tie">
                                                </i>
                                                <b>Admin: </b>{{Session::get('CurrentGroup')->Admin()->name}} <br>
                                                <i class="fas fa-user-friends">
                                                </i>
                                                <b>Followed by : </b>{{count(Session::get('CurrentGroup')->users)}}
                                                Users
                                            </div>
                                        </div>
                                    </div>
                        ...
                        --}}
                                        ...
                                        <div class="advanced">
                                            <div onclick="group_post('{{{ csrf_token() }}}')">
                                                <i class="fal fa-smile" onclick="group_post('{{{ csrf_token() }}}')"></i>
                                                <span>Post</span>
                                            </div>
                                            <div>
